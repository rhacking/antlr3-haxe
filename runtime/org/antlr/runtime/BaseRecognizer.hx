...
{
    public var numberOfSyntaxErrors(get, never) : Int;
    public var backtrackingLevel(get, never) : Int;
    public var backtrakingLevel(never, set) : Int;
    public var failed(get, never) : Bool;
    @:isVar public var tokenNames(get, set) : Array<Dynamic>;
    function set_tokenNames(tokenNames) {
        return (this.tokenNames = tokenNames);
    }
    public var grammarFileName(get, never) : String;
    public var sourceName(get, never) : String;

    public static var MEMO_RULE_FAILED : Int = -2;
    public static var MEMO_RULE_UNKNOWN : Int = -1;
    public static inline var INITIAL_FOLLOW_STACK_SIZE : Int = 100;
    
    // copies from Token object for convenience in actions
    public static var DEFAULT_TOKEN_CHANNEL : Int = TokenConstants.DEFAULT_CHANNEL;
    public static var HIDDEN : Int = TokenConstants.HIDDEN_CHANNEL;
    
    public static inline var NEXT_TOKEN_RULE_NAME : String = "nextToken";
    ...
    public function new(state : RecognizerSharedState = null)
    {
        if (state == null)
        {
            // don't ever let us have a null state
    ...
    public function reset() : Void
    {
        ...
        var i : Int = 0;
        while (state.ruleMemo != null && i < state.ruleMemo.length)
        {
            // wipe cache
    ...
    /** Match current input symbol against ttype.  Attempt
		 ...
		 */
    public function matchStream(input : IntStream, ttype : Int, follow : BitSet) : Dynamic
    {
        //System.out.println("match "+((TokenStream)input).LT(1));
        var matchedSymbol : Dynamic = getCurrentInputSymbol(input);
        if (input.LA(1) == ttype)
        {
            input.consume();
            state.errorRecovery = false;
    ...
    public function mismatchIsUnwantedToken(input : IntStream, ttype : Int) : Bool
    {
        return input.LA(2) == ttype;
    }
    
    public function mismatchIsMissingToken(input : IntStream, follow : BitSet) : Bool
    {
        if (follow == null)
        {
    ...
    /** Factor out what to do upon token mismatch so tree parsers can behave
		 ...
		 */
    private function mismatch(input : IntStream, ttype : Int, follow : BitSet) : Void
    {
    ...
    public function displayRecognitionError(tokenNames : Array<Dynamic>,
    ...
    /** What error message should be generated for the various
		 ...
		 *  exception types.
		 */
    public function getErrorMessage(e : RecognitionException, tokenNames : Array<Dynamic>) : String
    {
        var msg : String = e.message;
        var tokenName : String = null;
        if (Std.is(e, UnwantedTokenException))
        {
            var ute : UnwantedTokenException = cast((e), UnwantedTokenException);
            tokenName = "<unknown>";
        ...
        {
            if (Std.is(e, MissingTokenException))
            {
                var mite : MissingTokenException = cast((e), MissingTokenException);
                tokenName = "<unknown>";
            ...
            else
            {
                ...
                {
                    if (Std.is(e, MismatchedTreeNodeException))
                    {
                        var mtne : MismatchedTreeNodeException = cast((e), MismatchedTreeNodeException);
                        tokenName = "<unknown>";
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        if (Std.is(e, FailedPredicateException))
                                        {
                                            var fpe : FailedPredicateException = cast((e), FailedPredicateException);
    ...
    /** Get number of recognition errors (lexer, parser, tree parser).  Each
    	 ...
    	 */
    private function get_numberOfSyntaxErrors() : Int
    {
    ...
    /*  Compute the error recovery set for the current rule.  During
		 ...
		 */
    private function computeErrorRecoverySet() : BitSet
    {
    ...
    /** Compute the context-sensitive FOLLOW set for current rule.
		 ...
		 */
    private function computeContextSensitiveRuleFOLLOW() : BitSet
    {
        return combineFollows(true);
    }
    
    private function combineFollows(exact : Bool) : BitSet
    {
            ...
            follow : BitSet) : Dynamic
    {
        ...
        if (mismatchIsMissingToken(input, follow))
        {
            var inserted : Dynamic = getMissingSymbol(input, e, ttype, follow);
    ...
    /** Match needs to return the current input symbol, which gets put
		 ...
		 */
    private function getCurrentInputSymbol(input : IntStream) : Dynamic
    {
        return null;
    }
    ...
    /** Conjure up a missing token during error recovery.
		 ...
		 */
    private function getMissingSymbol(input : IntStream,
            e : RecognitionException,
    ...
    private function pushFollow(fset : BitSet) : Void
    {
        state.following[++state._fsp] = fset;
    }
    
    private function get_backtrackingLevel() : Int
    {
        return state.backtracking;
    }
    
    private function set_backtrakingLevel(n : Int) : Int
    {
    ...
    /** Used to print out token names like ID during debugging and
		 ...
		 */
    private function get_tokenNames() : Array<Dynamic>
    {
        return null;
    }
    ...
    /** For debugging and other purposes, might want the grammar name.
		 ...
		 */
    private function get_grammarFileName() : String
    {
        return null;
    }
    ...
    /** A convenience method for use most often with template rewrites.
		 ...
		 */
    public function toStrings(tokens : Array<Dynamic>) : Array<Dynamic>
    {
        if (tokens == null)
        {
            return null;
        }
        var strings : Array<Dynamic> = new Array<Dynamic>();
    ...
    public function getRuleMemoization(ruleIndex : Int, ruleStartIndex : Int) : Int
    {
        ...
        {
            state.ruleMemo[ruleIndex] = new Array<Dynamic>();
        }
        var stopIndex : Dynamic = state.ruleMemo[ruleIndex][ruleStartIndex];
        if (stopIndex == null)
        {
            return MEMO_RULE_UNKNOWN;
        }
        return as3hx.Compat.parseInt(stopIndex);
    }
    ...
    /** Has this rule already parsed input at the current index in the
		 ...
		 */
    public function alreadyParsedRule(input : IntStream, ruleIndex : Int) : Bool
    {
    ...
    public function getRuleMemoizationCacheSize() : Int
    {
        ...
        while (state.ruleMemo != null && i < state.ruleMemo.length)
        {
            var ruleMap : Dynamic = state.ruleMemo[i];
            if (ruleMap != null)
            {
                n += ruleMap.length;
            }
    ...
    public function traceInSymbol(ruleName : String, ruleIndex : Int, inputSymbol : Dynamic) : Void
    {
